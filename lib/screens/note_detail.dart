...
class NoteDetailState extends State<NoteDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      ...
      onWillPop: () {
        //Specify what happens whe user presses back navigation button in device
        moveToLastScreen();
      },
      child: Scaffold(
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              //specify what happens when user presses back button in AppBar
              moveToLastScreen();
            },
          ),
        ),
  ...
  //Convert int priority to String for display in Dropdown
  ...
  void _delete() async {
    ...
    //user wants to delete old note with valid id
